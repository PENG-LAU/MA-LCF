...
def train(args, opts):
    ...
    checkpoint_path_latest = os.path.join(opts.new_checkpoint, '3dhp_latest_epoch.pth.tr')
    checkpoint_path_best = os.path.join(opts.new_checkpoint, '3dhp_best_epoch.pth.tr')
